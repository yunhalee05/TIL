package kr.co.yunhalee.study.springbatch.configuration.simpletasklet
...
@Configuration
@ConditionalOnProperty(Constants.PROPERTY_JOB_NAME, havingValue = SimpleTasklet.JOB_NAME)
class SimpleTasklet(
    private val jobRepository: JobRepository
) {

    companion object {
        const val JOB_NAME = "simpleTasklet"
    }
