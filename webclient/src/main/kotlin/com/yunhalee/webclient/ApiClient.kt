...
class ApiClient(
    ...
    fun <T, E : RuntimeException> getForObjectWithQueryParamWithNumber(path: String, queryParams: Map<String, String>, returnType: Class<T>, exception: Class<E>): T? {
        return client.get()
    ...
    fun <T, E : RuntimeException> getForObjectWithQueryParamWithoutNumber(path: String, queryParams: Map<String, String>, returnType: Class<T>, exception: Class<E>): T? {
        return client.get()
            .uri { builder: UriBuilder ->
                builder.path(path)
                    .apply {
