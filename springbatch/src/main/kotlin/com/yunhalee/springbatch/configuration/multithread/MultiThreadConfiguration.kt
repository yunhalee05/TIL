package com.yunhalee.springbatch.configuration.multithread
...
@Configuration
@ConditionalOnProperty(Constants.PROPERTY_JOB_NAME, havingValue = MultiThreadConfiguration.JOB_NAME)
class MultiThreadConfiguration(
    private val jobRepository: JobRepository
) {

    companion object {
        const val JOB_NAME = "multi-thread"
    }
