package kr.co.yunhalee.study.springbatch.configuration.thread
...
@Configuration
@ConditionalOnProperty(Constants.PROPERTY_JOB_NAME, havingValue = ThreadConfiguration.JOB_NAME)
class ThreadConfiguration(
    private val jobRepository: JobRepository
) {

    companion object {
        const val JOB_NAME = "thread"
    }
