CREATE SEQUENCE SYSTEM_STEP_EXECUTION_SEQ;
CREATE SEQUENCE SYSTEM_JOB_EXECUTION_SEQ;
CREATE SEQUENCE SYSTEM_JOB_SEQ;
CREATE TABLE SYSTEM_STEP_EXECUTION_SEQ
(
    ID BIGINT NOT NULL
) type=InnoDB;
INSERT INTO SYSTEM_STEP_EXECUTION_SEQ
values (0);
CREATE TABLE SYSTEM_JOB_EXECUTION_SEQ
(
    ID BIGINT NOT NULL
) type=InnoDB;
INSERT INTO SYSTEM_JOB_EXECUTION_SEQ
values (0);
CREATE TABLE SYSTEM_JOB_SEQ
(
    ID BIGINT NOT NULL
) type=InnoDB;
INSERT INTO SYSTEM_JOB_SEQ
values (0);
